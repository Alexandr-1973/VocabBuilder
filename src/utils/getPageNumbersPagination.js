export const getPageNumbersPagination = (currentPage, expandedRange,totalPages) => {
    const pageNumbers = [];
    const range = 2; // Количество страниц до и после текущей страницы в среднем состоянии
